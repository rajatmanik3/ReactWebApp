...
namespace WebApp.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(ApplicationDbContext db, IConfiguration configuaration, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager)
        {
            _db = db;
            secretKey = configuaration.GetValue<string>("ApiSettings:Secret");
